              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                  <div class="testimonial-item d-flex align-items-center text-white p-5"
                    style="background: url('images/article-1.webp') center center / cover no-repeat; height: 300px; position: relative;">
                ...
                <div class="carousel-item">
                  <div class="testimonial-item d-flex align-items-center text-white p-5"
                    style="background: url('images/article-2.webp') center center / cover no-repeat; height: 300px; position: relative;">
                    <div style="position: absolute; inset: 0;"></div>
                  </div>
                </div>
                ...
                <div class="carousel-item">
                  <div class="testimonial-item d-flex align-items-center text-white p-5"
                    style="background: url('images/article-3.webp') center center / cover no-repeat; height: 300px; position: relative;">
                    <div style="position: absolute; inset: 0;"></div>
                  </div>
                </div>
